...
Last updated: `2026-07-13T16:43:28Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 186 |
| `cu-v1-whisper-deploy-cpu-arm64` | 22 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 84 |
| `cu-v1-whisper-deploy-cuda-arm64` | 0 |
| `cu-v1-whisper-deploy-cuda-other` | 0 |
| `cu-v1-whisper-upgrade-cpu-amd64` | 92 |
| `cu-v1-whisper-upgrade-cpu-arm64` | 8 |
...
| `cu-v1-kokoro-deploy-cpu-amd64` | 57 |
...
| `cu-v1-kokoro-upgrade-cpu-amd64` | 22 |
...
| `cu-v1-docling-deploy-cpu-amd64` | 50 |
| `cu-v1-docling-deploy-cpu-arm64` | 2 |
| `cu-v1-docling-deploy-cpu-other` | 0 |
| `cu-v1-docling-deploy-cuda-amd64` | 4 |
