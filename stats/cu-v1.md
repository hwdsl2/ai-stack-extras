...
Last updated: `2026-07-09T21:43:48Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 43 |
| `cu-v1-whisper-deploy-cpu-arm64` | 2 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 15 |
| `cu-v1-whisper-deploy-cuda-arm64` | 0 |
| `cu-v1-whisper-deploy-cuda-other` | 0 |
| `cu-v1-whisper-upgrade-cpu-amd64` | 20 |
| `cu-v1-whisper-upgrade-cpu-arm64` | 2 |
| `cu-v1-whisper-upgrade-cpu-other` | 0 |
| `cu-v1-whisper-upgrade-cuda-amd64` | 8 |
| `cu-v1-whisper-upgrade-cuda-arm64` | 0 |
| `cu-v1-whisper-upgrade-cuda-other` | 0 |
| `cu-v1-kokoro-deploy-cpu-amd64` | 12 |
...
| `cu-v1-kokoro-upgrade-cpu-amd64` | 5 |
...
| `cu-v1-docling-deploy-cpu-amd64` | 10 |
...
| `cu-v1-litellm-deploy-cpu-amd64` | 15 |
