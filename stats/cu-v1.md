...
Last updated: `2026-08-06T05:27:36Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 59 |
| `cu-v1-whisper-deploy-cpu-arm64` | 6 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 12 |
| `cu-v1-whisper-deploy-cuda-arm64` | 0 |
| `cu-v1-whisper-deploy-cuda-other` | 0 |
| `cu-v1-whisper-upgrade-cpu-amd64` | 9 |
| `cu-v1-whisper-upgrade-cpu-arm64` | 1 |
| `cu-v1-whisper-upgrade-cpu-other` | 0 |
| `cu-v1-whisper-upgrade-cuda-amd64` | 3 |
...
| `cu-v1-kokoro-upgrade-cpu-amd64` | 3 |
...
| `cu-v1-litellm-deploy-cpu-amd64` | 2 |
| `cu-v1-litellm-deploy-cpu-arm64` | 0 |
...
| `cu-v1-ollama-deploy-cpu-amd64` | 1 |
...
| `cu-v1-ollama-upgrade-cpu-amd64` | 1 |
