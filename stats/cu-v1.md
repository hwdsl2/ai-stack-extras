...
Last updated: `2026-07-30T10:33:42Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 1187 |
| `cu-v1-whisper-deploy-cpu-arm64` | 232 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 421 |
...
| `cu-v1-whisper-upgrade-cuda-amd64` | 219 |
| `cu-v1-whisper-upgrade-cuda-arm64` | 0 |
| `cu-v1-whisper-upgrade-cuda-other` | 0 |
| `cu-v1-kokoro-deploy-cpu-amd64` | 328 |
...
| `cu-v1-kokoro-upgrade-cpu-amd64` | 84 |
...
| `cu-v1-docling-deploy-cpu-amd64` | 177 |
...
| `cu-v1-docling-upgrade-cpu-amd64` | 26 |
...
| `cu-v1-mcp-deploy-cpu-amd64` | 110 |
...
| `cu-v1-embeddings-deploy-cpu-amd64` | 81 |
...
| `cu-v1-ollama-deploy-cpu-amd64` | 71 |
...
| `cu-v1-whisperlive-deploy-cuda-amd64` | 61 |
