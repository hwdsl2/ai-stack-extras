...
Last updated: `2026-08-16T03:13:31Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 653 |
| `cu-v1-whisper-deploy-cpu-arm64` | 268 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 173 |
...
| `cu-v1-ollama-upgrade-cuda-amd64` | 32 |
...
| `cu-v1-whisperlive-deploy-cuda-amd64` | 20 |
