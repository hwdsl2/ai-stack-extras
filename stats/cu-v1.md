...
Last updated: `2026-07-12T10:02:56Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 143 |
| `cu-v1-whisper-deploy-cpu-arm64` | 20 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 59 |
