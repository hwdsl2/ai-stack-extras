...
Last updated: `2026-07-27T21:29:26Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 1080 |
| `cu-v1-whisper-deploy-cpu-arm64` | 182 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 385 |
...
| `cu-v1-whisper-upgrade-cuda-amd64` | 205 |
| `cu-v1-whisper-upgrade-cuda-arm64` | 0 |
| `cu-v1-whisper-upgrade-cuda-other` | 0 |
| `cu-v1-kokoro-deploy-cpu-amd64` | 274 |
...
| `cu-v1-kokoro-upgrade-cpu-amd64` | 76 |
...
| `cu-v1-docling-deploy-cuda-amd64` | 27 |
...
| `cu-v1-litellm-deploy-cpu-amd64` | 96 |
...
| `cu-v1-ollama-deploy-cpu-arm64` | 5 |
