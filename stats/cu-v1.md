...
Last updated: `2026-07-20T11:12:33Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 582 |
| `cu-v1-whisper-deploy-cpu-arm64` | 89 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 209 |
...
| `cu-v1-whisper-upgrade-cuda-amd64` | 154 |
| `cu-v1-whisper-upgrade-cuda-arm64` | 0 |
| `cu-v1-whisper-upgrade-cuda-other` | 0 |
| `cu-v1-kokoro-deploy-cpu-amd64` | 170 |
...
| `cu-v1-docling-deploy-cpu-amd64` | 103 |
...
| `cu-v1-embeddings-deploy-cpu-amd64` | 29 |
...
| `cu-v1-whisperlive-deploy-cuda-amd64` | 29 |
