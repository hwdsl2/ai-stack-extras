...
Last updated: `2026-07-20T05:49:14Z`
...
| `cu-v1-whisper-deploy-cpu-arm64` | 88 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 207 |
| `cu-v1-whisper-deploy-cuda-arm64` | 0 |
| `cu-v1-whisper-deploy-cuda-other` | 0 |
| `cu-v1-whisper-upgrade-cpu-amd64` | 178 |
...
| `cu-v1-kokoro-deploy-cpu-amd64` | 166 |
...
| `cu-v1-kokoro-upgrade-cpu-amd64` | 49 |
...
| `cu-v1-litellm-deploy-cpu-amd64` | 61 |
...
| `cu-v1-whisperlive-deploy-cuda-amd64` | 26 |
