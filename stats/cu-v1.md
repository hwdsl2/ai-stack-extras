...
Last updated: `2026-07-16T21:15:41Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 362 |
| `cu-v1-whisper-deploy-cpu-arm64` | 75 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 139 |
...
| `cu-v1-whisper-upgrade-cuda-amd64` | 99 |
| `cu-v1-whisper-upgrade-cuda-arm64` | 0 |
| `cu-v1-whisper-upgrade-cuda-other` | 0 |
| `cu-v1-kokoro-deploy-cpu-amd64` | 123 |
...
| `cu-v1-kokoro-upgrade-cpu-amd64` | 40 |
...
| `cu-v1-docling-deploy-cpu-amd64` | 77 |
| `cu-v1-docling-deploy-cpu-arm64` | 4 |
| `cu-v1-docling-deploy-cpu-other` | 0 |
| `cu-v1-docling-deploy-cuda-amd64` | 13 |
