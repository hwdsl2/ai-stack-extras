...
Last updated: `2026-07-14T21:14:44Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 245 |
| `cu-v1-whisper-deploy-cpu-arm64` | 39 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 112 |
| `cu-v1-whisper-deploy-cuda-arm64` | 0 |
| `cu-v1-whisper-deploy-cuda-other` | 0 |
| `cu-v1-whisper-upgrade-cpu-amd64` | 109 |
...
| `cu-v1-kokoro-deploy-cpu-amd64` | 78 |
