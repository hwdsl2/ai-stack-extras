...
Last updated: `2026-08-08T03:44:29Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 211 |
| `cu-v1-whisper-deploy-cpu-arm64` | 75 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 42 |
| `cu-v1-whisper-deploy-cuda-arm64` | 0 |
| `cu-v1-whisper-deploy-cuda-other` | 0 |
| `cu-v1-whisper-upgrade-cpu-amd64` | 64 |
| `cu-v1-whisper-upgrade-cpu-arm64` | 6 |
| `cu-v1-whisper-upgrade-cpu-other` | 0 |
| `cu-v1-whisper-upgrade-cuda-amd64` | 34 |
...
| `cu-v1-kokoro-upgrade-cpu-amd64` | 11 |
...
| `cu-v1-docling-deploy-cpu-amd64` | 33 |
...
| `cu-v1-litellm-deploy-cpu-amd64` | 6 |
...
| `cu-v1-ollama-deploy-cpu-amd64` | 4 |
