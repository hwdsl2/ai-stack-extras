...
Last updated: `2026-08-29T09:04:32Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 2041 |
| `cu-v1-whisper-deploy-cpu-arm64` | 425 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 482 |
| `cu-v1-whisper-deploy-cuda-arm64` | 0 |
| `cu-v1-whisper-deploy-cuda-other` | 0 |
| `cu-v1-whisper-upgrade-cpu-amd64` | 390 |
| `cu-v1-whisper-upgrade-cpu-arm64` | 55 |
...
| `cu-v1-docling-deploy-cpu-amd64` | 202 |
| `cu-v1-docling-deploy-cpu-arm64` | 61 |
