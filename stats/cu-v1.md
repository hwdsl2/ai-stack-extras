...
Last updated: `2026-07-14T15:44:57Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 235 |
| `cu-v1-whisper-deploy-cpu-arm64` | 38 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 109 |
| `cu-v1-whisper-deploy-cuda-arm64` | 0 |
| `cu-v1-whisper-deploy-cuda-other` | 0 |
| `cu-v1-whisper-upgrade-cpu-amd64` | 106 |
...
| `cu-v1-kokoro-deploy-cpu-amd64` | 68 |
...
| `cu-v1-docling-deploy-cpu-amd64` | 64 |
...
| `cu-v1-litellm-deploy-cpu-amd64` | 40 |
