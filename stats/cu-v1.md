...
Last updated: `2026-07-30T16:00:04Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 1203 |
| `cu-v1-whisper-deploy-cpu-arm64` | 243 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 425 |
...
| `cu-v1-whisper-upgrade-cuda-amd64` | 221 |
| `cu-v1-whisper-upgrade-cuda-arm64` | 0 |
| `cu-v1-whisper-upgrade-cuda-other` | 0 |
| `cu-v1-kokoro-deploy-cpu-amd64` | 334 |
...
| `cu-v1-docling-deploy-cpu-amd64` | 178 |
| `cu-v1-docling-deploy-cpu-arm64` | 26 |
...
| `cu-v1-docling-upgrade-cpu-amd64` | 27 |
...
| `cu-v1-ollama-upgrade-cuda-amd64` | 17 |
