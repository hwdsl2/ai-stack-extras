...
Last updated: `2026-08-26T03:19:00Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 1725 |
| `cu-v1-whisper-deploy-cpu-arm64` | 390 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 431 |
| `cu-v1-whisper-deploy-cuda-arm64` | 0 |
| `cu-v1-whisper-deploy-cuda-other` | 0 |
| `cu-v1-whisper-upgrade-cpu-amd64` | 319 |
...
| `cu-v1-kokoro-deploy-cpu-amd64` | 225 |
...
| `cu-v1-kokoro-upgrade-cpu-amd64` | 52 |
...
| `cu-v1-mcp-deploy-cpu-amd64` | 145 |
...
| `cu-v1-embeddings-deploy-cpu-amd64` | 84 |
| `cu-v1-embeddings-deploy-cpu-arm64` | 0 |
| `cu-v1-embeddings-deploy-cpu-other` | 0 |
| `cu-v1-embeddings-upgrade-cpu-amd64` | 19 |
...
| `cu-v1-litellm-upgrade-cpu-amd64` | 36 |
...
| `cu-v1-whisperlive-upgrade-cuda-amd64` | 18 |
