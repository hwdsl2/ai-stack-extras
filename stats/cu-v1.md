...
Last updated: `2026-07-20T21:31:58Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 633 |
| `cu-v1-whisper-deploy-cpu-arm64` | 93 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 217 |
| `cu-v1-whisper-deploy-cuda-arm64` | 0 |
| `cu-v1-whisper-deploy-cuda-other` | 0 |
| `cu-v1-whisper-upgrade-cpu-amd64` | 183 |
| `cu-v1-whisper-upgrade-cpu-arm64` | 26 |
| `cu-v1-whisper-upgrade-cpu-other` | 0 |
| `cu-v1-whisper-upgrade-cuda-amd64` | 163 |
...
| `cu-v1-embeddings-deploy-cpu-amd64` | 35 |
...
| `cu-v1-litellm-deploy-cpu-amd64` | 66 |
