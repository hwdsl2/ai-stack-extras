...
Last updated: `2026-08-11T03:55:21Z`
...
| `cu-v1-kokoro-deploy-cpu-amd64` | 65 |
...
| `cu-v1-kokoro-upgrade-cpu-amd64` | 18 |
...
| `cu-v1-docling-deploy-cpu-amd64` | 53 |
| `cu-v1-docling-deploy-cpu-arm64` | 19 |
| `cu-v1-docling-deploy-cpu-other` | 0 |
| `cu-v1-docling-deploy-cuda-amd64` | 9 |
...
| `cu-v1-mcp-deploy-cpu-amd64` | 26 |
| `cu-v1-mcp-deploy-cpu-arm64` | 7 |
| `cu-v1-mcp-deploy-cpu-other` | 0 |
| `cu-v1-mcp-upgrade-cpu-amd64` | 9 |
