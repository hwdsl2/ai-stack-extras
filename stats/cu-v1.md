...
Last updated: `2026-08-24T03:17:20Z`
...
| Asset | Count |
|---|---:|
| `cu-v1-whisper-deploy-cpu-amd64` | 1158 |
| `cu-v1-whisper-deploy-cpu-arm64` | 384 |
| `cu-v1-whisper-deploy-cpu-other` | 0 |
| `cu-v1-whisper-deploy-cuda-amd64` | 306 |
| `cu-v1-whisper-deploy-cuda-arm64` | 0 |
| `cu-v1-whisper-deploy-cuda-other` | 0 |
| `cu-v1-whisper-upgrade-cpu-amd64` | 304 |
| `cu-v1-whisper-upgrade-cpu-arm64` | 40 |
| `cu-v1-whisper-upgrade-cpu-other` | 0 |
| `cu-v1-whisper-upgrade-cuda-amd64` | 184 |
| `cu-v1-whisper-upgrade-cuda-arm64` | 0 |
| `cu-v1-whisper-upgrade-cuda-other` | 0 |
| `cu-v1-kokoro-deploy-cpu-amd64` | 211 |
...
| `cu-v1-kokoro-upgrade-cpu-amd64` | 50 |
...
| `cu-v1-docling-deploy-cpu-amd64` | 174 |
...
| `cu-v1-mcp-deploy-cpu-amd64` | 137 |
| `cu-v1-mcp-deploy-cpu-arm64` | 20 |
| `cu-v1-mcp-deploy-cpu-other` | 0 |
| `cu-v1-mcp-upgrade-cpu-amd64` | 39 |
...
| `cu-v1-litellm-deploy-cpu-amd64` | 83 |
...
| `cu-v1-ollama-deploy-cpu-amd64` | 65 |
...
| `cu-v1-whisperlive-upgrade-cuda-amd64` | 16 |
